...
/**
 * Proxy API para los endpoints de evaluaciones del módulo docente
...
export async function GET(
  ...
  try {
    ...
    const url = `${BACKEND_BASE_URL}/teaching/courses/${params.courseId}/assessments`
    ...
    console.error('Error in assessments proxy (GET):', error)
