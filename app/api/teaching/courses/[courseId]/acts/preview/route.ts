...
/**
 * Proxy API para el preview de actas
 */
export async function GET(
  ...
  try {
    ...
    const url = `${BACKEND_BASE_URL}/teaching/courses/${params.courseId}/acts:preview`
    ...
    console.error('Error in acts preview proxy (GET):', error)
